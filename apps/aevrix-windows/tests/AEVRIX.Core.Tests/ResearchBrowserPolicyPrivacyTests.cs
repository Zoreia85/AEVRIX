...
public sealed class ResearchBrowserPolicyPrivacyTests
{
    ...
    [TestMethod]
    public void Validate_RejectsPersistentStateThatSurvivesProjectDeletion()
    {
        var policy = CreatePolicy() with
        {
            PersistTargetProfile = true,
    ...
    [TestMethod]
    public void Validate_AllowsExplicitPersistentAuthorizedPolicyWithDeletionCleanup()
    {
        var policy = CreatePolicy() with
        {
            PersistTargetProfile = true,
