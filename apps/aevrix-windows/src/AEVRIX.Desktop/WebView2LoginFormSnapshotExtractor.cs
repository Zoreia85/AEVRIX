...
/// <summary>
/// Executes the fixed value-free DOM collector only while the current WebView2 page remains inside the
/// active project's governed HTTPS boundary. Returned browser data is treated as untrusted and strictly
/// parsed by Core before any discovery decision is made.
/// </summary>
