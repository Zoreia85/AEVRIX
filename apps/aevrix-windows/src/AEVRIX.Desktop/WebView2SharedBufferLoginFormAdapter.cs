...
public sealed class WebView2SharedBufferLoginFormAdapter : IResearchBrowserAtomicLoginFormAdapter
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            // The managed packet is no longer needed once the bytes are copied into WebView2-owned memory.
            packet.Dispose();
            ...
            // WebView2 keeps the backing mapping alive for the renderer view until releaseBuffer is called.
            sharedBuffer.Close();
