...
/// <summary>
/// Resolves the login recipe from the browser's actual current URL instead of requiring callers to select a recipe.
/// This is the intended bridge for governed scan/relogin flows: execution authorization is checked first, then the
/// current project/policy and current page, then the non-secret recipe, and only finally the credential coordinator.
/// </summary>
public sealed class ProjectCurrentPageLoginService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // Fail before project/recipe/secret access when this scan is not authorized to use credentials.
