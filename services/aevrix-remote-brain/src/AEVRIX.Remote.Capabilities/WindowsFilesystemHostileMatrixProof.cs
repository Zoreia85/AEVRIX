...
/// read isolation from AppContainer presence, Low Integrity, workspace ACLs, working-directory
/// containment, or a denied external write. Every hostile read boundary must be observed directly.
/// </summary>
