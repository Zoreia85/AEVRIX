...
/// <summary>
/// The only helper that upgrades hostile observations into a filesystem authority attestation.
/// It refuses to mint granular proof flags unless the complete matrix is bound to the exact policy.
/// </summary>
