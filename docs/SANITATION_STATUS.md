...
| #364 AI provider budget gate | BLOCKED_UNTIL_PRIVATE / ARCHIVE_EVIDENCE | Unique remote-brain budgeting logic exists, but this is strategic core/provider-accounting logic and is outside the temporary public-safe expansion boundary. Preserve for provenance; do not advance publicly. |
